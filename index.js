...
(function(){
  var React, build, create, install, type, buildPug, pug, html, svg, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
  ...
  */
  ...
  out$.pug = pug = function(tag, v2, v3){
    switch (toString$.call(v2).slice(8, -1)) {
    case 'Object':
      return buildPug(tag, v2, v3);
    default:
      return buildPug(tag, {}, v3);
    }
  };
